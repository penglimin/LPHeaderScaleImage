#
#  Be sure to run `pod spec lint LPHeaderScalemage.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "http://EXAMPLE/LPHeaderScalemage"
  ...
  s.source       = { :git => "http://EXAMPLE/LPHeaderScalemage.git", :tag => "0.0.1" }
